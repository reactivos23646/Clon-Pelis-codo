                ...
                <nav className="navbar navbar-expand-lg navbar navbar-dark bg-dark" data-bs-theme="dark">
                    <div className="container-fluid">
                        <a className="navbar-brand" href="#">
                            <img src="./src/picture/logoNetflix.png" width="120" height="120" alt="logo"></img>
                        </a>
                                ...
                                <ul className="navbar-nav">
                                    <li className="nav-item dropdown-center">
                                        <a className="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                            <img src="./src/picture/avatar_1.jpg" className="rounded float-start" width="40" height="40" alt="avatar"></img>
                                        </a>
